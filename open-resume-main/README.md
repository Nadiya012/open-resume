...
OpenResume is a powerful open-source resume builder and parser.

The goal of OpenResume is to provide free access to modern professional resume design, so anyone can apply for jobs with confidence.
...
| **5. Proven Track Record** | OpenResume users have landed interviews and offers from top companies such as Dropbox, Google, and Meta. It has been proven to work and is liked by recruiters and hiring managers. |
...
| **Web Framework** | [Next.js 13](https://github.com/vercel/next.js) | Next.js supports static site generation and helps build efficient React webpages that support SEO. |
